...
> 🚀 Built with [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/), timestamp `2022-08-05 14:16`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/eb28ac09-0811-4e2d-8f78-a7f87be6958a.git
$ cd eb28ac09-0811-4e2d-8f78-a7f87be6958a
```
